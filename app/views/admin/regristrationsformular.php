...
<body>
  <div class="grid-container">
    ...
    <header class="header">
      <div class="header__avatar">Welcome <?php echo isset($data['username']) ? htmlspecialchars($data['username']) : 'Guest'; ?>!</div>
    </header>
    ...
    <main class="main">
      <div class="main-cards">
        <div class="card">
          ...
          <form action="<?php echo URLROOT; ?>/admin/registerAdmin" method="POST">
