    ...
    <div class="grid-container">
        ...
        <main class="main">
            <div class="main-cards">
                <div class="card">
                    <h2>Blogpost bearbeiten</h2>
                    <form action="<?php echo URLROOT; ?>/admin/editBlogpost/<?php echo $data['id']; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($data['image'])): ?>
                                <img src="<?php echo URLROOT . '/uploads/' . htmlspecialchars(basename($data['image'])); ?>" alt="<?php echo $data['title']; ?>">
                            <?php endif; ?>
                        </div>
