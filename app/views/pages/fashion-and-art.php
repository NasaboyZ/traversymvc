...
<body>
    ...
    <section class="news-horenzotial-letter">
        <div class="container-for-news-latter">
            <p class="move-newsletter">Next M.W.C Event: 09 / 28 / 24 Sign up! | Next Sustainability Event: 06 / 08 / 2 Sign up! </p>
        </div>
    </section>

    <h2 class="sub title-für-die-erste-section">AI Gen</h2>

    <section class="section-marina-section">
        <div class="section">
            <h2 class="sub">Marina Maroni</h2>
            <p class="fliestext-in-container-marina">Marina Maroni, eine Pionierin in der KI-Mode, schuf eine bahnbrechende AI-Plattform, die personalisierte Modeempfehlungen auf Basis von Kundenpräferenzen und Trenddaten bereitstellte. Die Integration von KI in die Modedesign- und Produktionsprozesse reduzierte Abfall und erhöhte die Effizienz, was die Modebranche nachhaltiger gestaltete. Maroni verband Technologie und Kunst, indem sie AI-generierte Modekollektionen auf den Laufstegen präsentierte, was die Zukunft der Modeindustrie neu definierte. Ihre Beiträge zur KI-Mode inspirierten eine neue Generation von Designern und Technologen, nachhaltige und innovative Lösungen zu schaffen.</p>
        </div>
        <div class="img-container-marina">
            <img class="img aufnahme-in-container" src="<?php echo URLROOT; ?>/assets/bilder/zwei-schwester-ein-laptop.png" srcset="<?php echo URLROOT; ?>/assets/bilder/zwei-schwester-ein-laptop.webp" alt="die schwestern haben einen unglaublichen plan Sie rufen Jayz an und freuen sich auf das bild.">
        </div>
    </section>
            ...
            <div class="container-arcodion">
                <div class="arccodion" id=".box-c">
                    <div class="contentBx">
                        ...
                        <div class="content">
                            <p class="text fliestext-arcodion">Ideen sind kreative Bausteine, die Innovation und Fortschritt antreiben, als leuchtende Impulse für neue Entdeckungen und bedeutungsvolle Schöpfungen.</p>
                        </div>
                    </div>
                    <div class="contentBx">
                        <div class="label">Creativity</div>
                        <div class="content">
                            <p class="text">Kreativität ist der Schlüssel zu unendlichen Möglichkeiten und Ausdrucksformen, ein Quellpunkt, der in der Fähigkeit liegt, Gedanken in einzigartige Konzepte zu formen und dabei konventionelle Grenzen zu durchbrechen.</p>
                        </div>
                    </div>
                    <div class="contentBx">
                        <div class="label">Minimalistic</div>
                        <div class="content">
                            <p class="text">Minimalistische Kunst zeichnet sich durch ihre Reduktion auf das Wesentliche aus, wo leere Räume, klare Linien und einfache Formen subtile Eleganz und Tiefe erzeugen.</p>
                        </div>
                    </div>
                    <div class="contentBx">
                        <div class="label">Studio</div>
                        <div class="content">
                            <p class="text">In einem kreativen Kunststudio entstehen faszinierende Werke, wenn talentierte Künstler ihre inspirierten Ideen in beeindruckende Kunstwerke umsetzen.</p>
                        </div>
                    </div>
                </div>
            </div>
